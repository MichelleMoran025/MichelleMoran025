...
>  Se deberán entregar las resoluciones en un archivo Readme.md de un repositorio de github público. Aquí un instructivo de como hacer uno. Se valorará muchísimo el nivel de presentación teniendo en cuenta en cuenta la redacción, faltas de ortografía, uso de tabulación, tamaños de fuentes y diversas herramientas que entrega el readme para hacer más fácil su comprensión. 
